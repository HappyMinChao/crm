...
public interface SalesChanceMapper {
	...
	/**
	 *@Description:  根据ID查询销售机会，用于销售机会分配功能
	 *@Author:du_minchao
	 *@CreateDate:29 Mar 2016
	 *@return:SalesChance
	 */
	public abstract SalesChance getElementById(Integer id);
	...
	/**
	 * 将sales_chance的status设置为3 开发成功-- by ning
	 * @param chance
	 */
	void developSuccess(SalesChance chance);
	/**
	 * 将sales_chance的status设置为4 失败-- by ning
	 * @param chance
	 */
	void developFail(SalesChance chance);
