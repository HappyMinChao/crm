...
public class Customer extends IdEntity{
	...
	public String toString() {
		return "Customer [no=" + no + ", name=" + name + ", region=" + region
				+ ", manager=" + manager + ", level=" + level + ", satify="
				+ satify + ", credit=" + credit + ", address=" + address
				+ ", zip=" + zip + ", tel=" + tel + ", fax=" + fax
				+ ", websit=" + websit + ", licenceNo=" + licenceNo
				+ ", chief=" + chief + ", bankroll=" + bankroll + ", turnover="
				+ turnover + ", bank=" + bank + ", bankAccount=" + bankAccount
				+ ", localTaxNo=" + localTaxNo + ", nationalTaxNo="
				+ nationalTaxNo + ", state=" + state + ", contacts=" + contacts
				+ ", orders=" + orders + "]";
	}
